...
namespace FieldEvolver
{
        
        void evolve_Bfield(const Vector<Array<const MultiFab*, AMREX_SPACEDIM>>& E,
                           const Vector<Array<MultiFab*, AMREX_SPACEDIM>>& B,
                           const YeeGrid& EMYeeGrid, const Vector<Geometry>& geom,
                           Vector<Real> dt);

        void evolve_Efield(const Vector<Array<const MultiFab*, AMREX_SPACEDIM>>& B,
                           const Vector<Array<const MultiFab*, AMREX_SPACEDIM>>& j,
                           const Vector<Array<MultiFab*, AMREX_SPACEDIM>>& E,
                           const YeeGrid& EMYeeGrid, const Vector<Geometry>& geom,
                           Vector<Real>& dt);
